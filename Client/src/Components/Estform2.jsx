...
function Estform2(){
    ...
    const [data_est,setdata_est]=useState({
        ...
        const revert_back=async()=>{
            if(user_t === "superintendent"){
                navigate("/estabpage/"+auth.currentUser.uid+"/new")
                const response1 = await fetch("https://ltc-mgmt.herokuapp.com/superintendent_Revert",{
                method:"POST",
            ...
            {
                navigate("/estabpage/"+auth.currentUser.uid+"/new")
                const response1 = await fetch("https://ltc-mgmt.herokuapp.com/asst_registrar_Revert",{
                method:"POST",
                headers: {"Content-type":"application/json"},
                body: JSON.stringify(e)
                });
            ...
            else if(user_t==="asstauditofficer")
            {
                navigate("/estabpage/"+auth.currentUser.uid+"/new")
                const response1 = await fetch("https://ltc-mgmt.herokuapp.com/asst_audit_officer_Revert",{
                method:"POST",
                headers: {"Content-type":"application/json"},
                body: JSON.stringify(e)
                });
            ...
            else if(user_t==="audit_officer")
            {
                navigate("/estabpage/"+auth.currentUser.uid+"/new")
                const response1 = await fetch("https://ltc-mgmt.herokuapp.com/audit_officer_Revert",{
                method:"POST",
                headers: {"Content-type":"application/json"},
                body: JSON.stringify(e)
                });
            }
            else if(user_t==="senior")
            {
                navigate("/estabpage/"+auth.currentUser.uid+"/new")
                const response1 = await fetch("https://ltc-mgmt.herokuapp.com/sr_audit_officer_Revert",{
                method:"POST",
                headers: {"Content-type":"application/json"},
                body: JSON.stringify(e)
                });
        ...
        const response_ = await fetch("https://ltc-mgmt.herokuapp.com/getusertype/"+auth.currentUser.uid)
        const dataa = await response_.json()
        console.log(dataa)
        
        if(dataa ==="superintendent"){
            navigate("/estabpage/"+auth.currentUser.uid+"/new")
            const response =  await fetch("https://ltc-mgmt.herokuapp.com/j_spr_update/",{
            method:"POST",
            headers: {"Content-type":"application/json"},
            body: JSON.stringify(e)
            });
        ...
        else if(dataa ==="registrar"){
            navigate("/estabpage/"+auth.currentUser.uid+"/new")
            const response = await fetch("https://ltc-mgmt.herokuapp.com/asst_reg_update",{
            method:"POST",
            headers: {"Content-type":"application/json"},
            body: JSON.stringify(e)
            });
        ...
        else if(dataa==="asstauditofficer"){
            navigate("/auditpage/"+auth.currentUser.uid+"/new")
            // console.log("mai bhadwa hu")
            const response = await fetch("https://ltc-mgmt.herokuapp.com/audit0_update",{
            method:"POST",
            headers: {"Content-type":"application/json"},
            body: JSON.stringify(e)
            });
        }
        else if(dataa==="audit_officer"){
            navigate("/auditpage/"+auth.currentUser.uid+"/new")
            // console.log("mai bhadwa hu")
            const response = await fetch("https://ltc-mgmt.herokuapp.com/audit1_update",{
            method:"POST",
            headers: {"Content-type":"application/json"},
            body: JSON.stringify(e)
            });
        }
        else if(dataa==="senior"){
            navigate("/auditpage/"+auth.currentUser.uid+"/new")
            // console.log("mai bhadwa hu")
            const response = await fetch("https://ltc-mgmt.herokuapp.com/audit2_update",{
            method:"POST",
            headers: {"Content-type":"application/json"},
            body: JSON.stringify(e)
            });
        }
        else if(dataa==="jr_acc"){
        ...
        else if(dataa==="acc_asst_registrar"){
            navigate("/accountspage/"+auth.currentUser.uid+"/new")
            // console.log("mai bhadwa hu")
        ...
        else if(dataa==="acc_deputy_registrar"){
            navigate("/accountspage/"+auth.currentUser.uid+"/new")
            // console.log("mai bhadwa hu")
    ...
    return(<>
        ...
        <div className={styles.container}>
            ...
            <button type="submit" className={styles.add} class="btn btn-primary">Add Comments</button>
            <div className={styles.btns}>
                <button type="button" className={styles.revert} onClick={revert_back}>Revert Back with comments</button>
                <button type="button" onClick={function_1} className={styles.forward}>Approve</button>
            </div>
            </>:<></>}
