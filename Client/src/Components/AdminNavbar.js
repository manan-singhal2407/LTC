  ...
  return (
    ...
    <AppBar position="static">
        <Toolbar className={styles.a1}>
          ...
          <h2 style={{color: "white"}}>HOD Section</h2>
            <Link to={"/adminpage/" + auth.currentUser.uid + "/previous"} className={styles.a3}>
              Previous Applications
            </Link>
            <Link to= {"/adminpage/"+auth.currentUser.uid+"/new"} className={styles.a3}>
              New Applications
            </Link>
          </Typography>
